...
const Blog = () => {
  return (
    <div>
      ...
      <p className="my-2">
        <span className="text-xl">Answer:</span> There are four main types of
        state you need to properly manage in your React apps: Local state,
        Global state, Server state,URL state <br></br>Local (UI) state – Local
